...
parser.add_argument('--save_dir', default='./semi_waae/', help='save dir')
...
logger = SimpleLogger.SimpleLogger(('epoch', 'iter', 'reconLoss', 'minimaxEncDLoss', 'encDLoss', 'time'), '[%d][%d] reconLoss: %.6f mmEncD: %.6f encD: %.6f time: %.2f')
...
#         
        ...
        logger.add((epoch, iteration, reconLoss.data[0], minimaxEncDLoss.data[0], encDLoss.data[0], deltaT))
