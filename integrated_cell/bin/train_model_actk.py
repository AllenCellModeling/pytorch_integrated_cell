...
def setup_kwargs_data_provider(args):
    ...
    data_provider_kwargs["channel_names"] = args["channel_names"]
...
def main():
    ...
    parser.add_argument(
        ...
        nargs="+",
        type=str,
        default=["nucleus_segmentation", "membrane_segmentation", "structure"],
        help="channels to use for the model",
    )
    ...
    args["channel_names"] = args["channels"]
