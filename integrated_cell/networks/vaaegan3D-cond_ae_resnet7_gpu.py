...
class Dec(nn.Module):
    ...
    def forward(self, x_in):
        ...
        x_class = x_class.cuda(gpu_ids[1])
        x_ref = x_ref.cuda(gpu_ids[1])
        x_target = x_target.cuda(gpu_ids[1])
