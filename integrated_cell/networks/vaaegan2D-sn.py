...
class Dec(nn.Module):
    def __init__(self, nLatentDim, nClasses, nRef, nch, gpu_ids, output_padding = (0,1)):
        ...
        self.main = nn.Sequential(
            ...
            nn.ReLU(inplace=True),
            spectral_norm(nn.ConvTranspose2d(1024, 1024, ksize, dstep, 1, output_padding = output_padding)),
            nn.BatchNorm2d(1024),
            ...
            nn.ReLU(inplace=True),
            spectral_norm(nn.ConvTranspose2d(64, nch, ksize, dstep, 1)),
            # nn.BatchNorm2d(nch),
            nn.Sigmoid()             
        )
