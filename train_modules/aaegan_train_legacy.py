...
def iteration(models, optimizers, criterions, dataProvider, iteration, opt):
    ...
    yHatFake2 = decD(dec(zReal))
    errEncD_fake2 = criterion(yHatFake2, yFake)
...
#     xHat = dec(zFake.detach())
    ...
    # pdb.set_trace()
    errors = (reconLoss.data[0], minimaxEncDLoss.data[0], encDLoss.data[0], minimaxDecLoss.data[0], decDLoss.data[0])
